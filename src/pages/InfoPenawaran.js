...
import { acceptTransaction, getTransDetail, cancelTransaction, successTransaction } from "../redux/action/transactionAction"
                        ...
                        <div className="modal-content">
                          ...
                          <div className="modal-body mx-4">
                            ...
                            <div className="form-check my-4">
                              <input className="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="success" onChange={(e) => handleStatus(e.target.value)}/>
                              <label className="form-check-label" for="exampleRadios1">
                                <h4 className="fw-bold">Berhasil terjual</h4>
                                <p className="text-secondary">Kamu telah sepakat menjual produk ini kepada pembeli</p>
                              </label>
                            </div>
                            <div className="form-check mb-4">
                              <input className="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="cancel" onChange={(e) => handleStatus(e.target.value)}/>
                              <label className="form-check-label" for="exampleRadios1">
                                <h4 className="fw-bold">Batalkan transaksi</h4>
                                <p className="text-secondary">Kamu membatalkan transaksi produk ini dengan pembeli</p>
                              </label>
                            </div>
                          </div>

    ...
    <>
      ...
      <Container>
          ...
          <div className="card-body">
            <div className="card-body-produk px-3">
              ...
              <div class="d-grid gap-2">
                <button class="btn_teks btn1 text-white" type="button">
                  <a href="/seller/daftar-jual">Terbitkan</a>
                </button>
                <button class="btn-teks btn2" type="button">
                  <a href="/info-produk">Edit</a>
                </button>
              </div>
            </div>
        ...
        <div className="container3">
          <button class="btn_teks btn1 btn-float text-white" type="button">
            <a href="/seller/daftar-jual">Terbitkan</a>
          </button>
        </div>
      </Container>

    ...
    <>
      ...
      <Container>
        ...
        <div className="container3">
          <button
            class="btn1 btn_teks btn-float text-white"
            type="button"
            onClick={handleShow}
          >
            Saya Tertarik dan ingin Nego
          </button>
          <button class="btn1 btn_teks btn-float text-white" type="button">
            Tambahkan ke Wishlist
          </button>
        </div>
        ...
        <Modal show={show} onHide={handleClose}>
              ...
              <div className="row">
                <div className="col-2 align-self-center">
                  <Image
                    ...
                    src={
                      `http://localhost:5000/upload/images/` + productInfo.image
                    }
                  />
                </div>
                <div className="col-8">
          ...
          <Modal.Footer>
            <button
              className="btn-kirim btn-teks justify-content-center align-items-center text-white"
              onClick={() => handleBuy()}
            >
              Kirim
            </button>
